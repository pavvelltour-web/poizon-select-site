  ...
  return (
    <LegalDocument eyebrow="Редакция от 31 июля 2026 года" title="Публичная оферта">
      ...
      <section>
        ...
        <p>
          Цена указывается в рублях. Итоговая сумма, включая применимую доставку,
          показывается до перехода к платёжному партнёру. Доступные способы оплаты
          отображаются на защищённой платёжной странице. Электронный чек направляется
